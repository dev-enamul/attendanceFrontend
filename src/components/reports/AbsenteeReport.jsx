...
import { UserX, Download, Search, Filter, AlertTriangle, Calendar } from 'lucide-react';
...
export const AbsenteeReport = () => {
  ...
  const fetchReport = async (params = {}) => {
    try {
      setLoading(true);
      const response = await reportsApi.getAbsenteeReport({ ...filters, ...params });
      if (response.success) {
          ...
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-4 lg:px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Continuous Absent</th>
                <th className="px-4 lg:px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">This Week</th>
                <th className="px-4 lg:px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">This Month</th>
                <th className="px-4 lg:px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">This Year</th>
                <th className="px-4 lg:px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Alert Level</th>
              </tr>
            </thead>
